...
/** Inline every emitted stylesheet into index.html — the .li gateway has served
 *  external stylesheets as text/html, and a stylesheet that isn't a separate
 *  file can't go missing. Same reason as rabbithole/amazdot. */
function inlineCss(): Plugin {
  return {
    name: 'forum:inline-css',
    apply: 'build',
    enforce: 'post',
