...
/* Vendored from github.com/conorbronsdon/avoid-ai-writing (MIT, Conor Bronsdon).
 * The file above is upstream byte-for-byte; the two lines below are the only
 * addition, because this app loads it as an ES module rather than a script tag. */
export { AIDetector };
