...
const EN = {
  ...
  'write.demo': 'Saved on this device only — not on chain. To post it for real, open the store inside the Polkadot app, or connect an EVM wallet in this browser.',
...
const IT: Dict = {
  ...
  'write.demo': 'Salvata solo su questo dispositivo — non sulla catena. Per pubblicarla davvero, apri lo store dentro la Polkadot app, oppure collega un portafoglio EVM in questo browser.',
...
const ES: Dict = {
  ...
  'reviews.count.one': '{n} valoración',
  ...
  'write.demo': 'Guardada solo en este dispositivo — no en la cadena. Para publicarla de verdad, abre la tienda dentro de la app de Polkadot, o conecta una cartera EVM en este navegador.',
...
const FR: Dict = {
  ...
  'write.demo': 'Enregistré sur cet appareil uniquement — pas sur la chaîne. Pour le publier réellement, ouvrez la boutique dans l’app Polkadot, ou connectez un portefeuille EVM dans ce navigateur.',
