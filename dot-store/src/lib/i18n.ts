...
const EN = {
  ...
  'cat.social': 'Social',
  'cat.finance': 'Finance',
  'cat.explorers': 'Explorers & data',
  'cat.tools': 'Tools',
  'cat.identity': 'Identity',
  'cat.publishing': 'Publishing',
  'cat.media': 'Media',
  'cat.curiosities': 'Curiosities',
  'cat.h': 'Browse by category',
  'cat.declared': 'Category declared by the developer.',
  'cat.inferred': 'Category inferred by dot-store from the app’s own words — not the developer’s claim.',
  ...
  'dev.category': 'To choose the category your app is filed under, instead of letting us infer it:',
...
const IT: Dict = {
  ...
  'cat.social': 'Social',
  'cat.finance': 'Finanza',
  'cat.explorers': 'Esploratori e dati',
  'cat.tools': 'Strumenti',
  'cat.identity': 'Identità',
  'cat.publishing': 'Pubblicazione',
  'cat.media': 'Media',
  'cat.curiosities': 'Curiosità',
  'cat.h': 'Sfoglia per categoria',
  'cat.declared': 'Categoria dichiarata dallo sviluppatore.',
  'cat.inferred': 'Categoria dedotta da dot-store dalle parole dell’app — non è una dichiarazione dello sviluppatore.',
  ...
  'dev.category': 'Per scegliere la categoria in cui finisce la tua app, invece di lasciarla dedurre a noi:',
...
const ES: Dict = {
  ...
  'cat.explorers': 'Exploradores y datos',
  'cat.tools': 'Herramientas',
  'cat.identity': 'Identidad',
  'cat.publishing': 'Publicación',
  'cat.media': 'Medios',
  'cat.curiosities': 'Curiosidades',
  'cat.h': 'Explorar por categoría',
  'cat.declared': 'Categoría declarada por el desarrollador.',
  'cat.inferred': 'Categoría deducida por dot-store de las palabras de la app — no es una afirmación del desarrollador.',
  ...
  'dev.category': 'Para elegir la categoría en la que se archiva tu app, en vez de dejar que la deduzcamos:',
...
const FR: Dict = {
  ...
  'cat.social': 'Social',
  'cat.finance': 'Finance',
  'cat.explorers': 'Explorateurs et données',
  'cat.tools': 'Outils',
  'cat.identity': 'Identité',
  'cat.publishing': 'Publication',
  'cat.media': 'Médias',
  'cat.curiosities': 'Curiosités',
  'cat.h': 'Parcourir par catégorie',
  'cat.declared': 'Catégorie déclarée par le développeur.',
  'cat.inferred': 'Catégorie déduite par dot-store des mots de l’app — ce n’est pas une déclaration du développeur.',
  ...
  'dev.category': 'Pour choisir la catégorie sous laquelle votre app est classée, au lieu de nous laisser la déduire :',
